...
data/final/qa.jsonl                    10539 pairs {question,answer,source,entity_type,season}
```
QA: `5745` race_result · `2039` qualifying · `1748` driver_bio · `364` champion · `177` circuit · `121` career_total · `83` person · `80` season · `63` f1_knowledge · `80` h2h · `31` incident · `8` regulation
...
flowchart TB
    ...
    subgraph OUTPUT["Dataset"]
        ...
        H["<b>qa.jsonl</b><br/>10539 pairs · 3.5 MB"]
