...
> Point to **one file**: `data/final/qa.jsonl` (10639 pairs). Don't point to folder — `data/` is 139M raw.
...
python pipeline/06_expand_dataset.py      # qual 2039 + circuits 177 + h2h 80 + 5× 2298 + regs 8 + career_total 221 → 10639
```
